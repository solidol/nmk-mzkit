...
| ![Рис. Фіксований макет](img/fixed_layout(lab8).png) |
| :------------------------------------- |
...
<!-- | ![Рис. Гнучкий макет варіант 1](img/0602a.png) | ![Рис. Гнучкий макет варіант 2](img/0602b.png) |
|:-----------------------------------------------|:-----------------------------------------------|
| Рис. Гнучкий макет варіант 1 | Рис. Гнучкий макет варіант 2 |
|:------------------------------------------------------------|
| HTML та CSS для такого макету може виглядати наступним чином: | -->

| ![Рис. Гнучкий макет варіант 1](img/Flexible_layout№1(lab8).png) |
|:-----------------------------------------------|
...
```
| ![Рис. Гнучкий макет варіант 2](img/Flexible_layout№2(lab8).png) |
|:-----------------------------------------------|
...
|![Рис. Адаптивний макет](img/Mobile(lab8).png)|
|:-------------------------------------|
| Рис. Адаптивний макет для мобільних пристроїв |

|![Рис. Адаптивний макет](img/laptop(lab8).png)|
|:-------------------------------------|
| Рис. Адаптивний макет для ноутбуків |

|![Рис. Адаптивний макет](img/PC(lab8).png)|
|:-------------------------------------|
| Рис. Адаптивний макет для ПК |
...
|![Рис. Прототип сторінки на великий екран](img/prototype_fullscreen(lab8).png)|
|:--------------------------------------------------------|
| Рис. Прототип сторінки на великий екран |

|![Рис. Прототип сторінки на середній екран](img/prototype_normal_screen(lab8).png)|
|:---------------------------------------------------------|
| Рис. Прототип сторінки на середній екран |

|![Рис. Прототип сторінки на мобільний пристрій](img/prototype_mobile(lab8).png)|
|:-------------------------------------------------------------|
