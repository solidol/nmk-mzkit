# Використання методу блочного верстання для створення каркасу документу ч. 2
...
| <img src="img/05010.gif" height="400" width="400"/> | <img src="img/05020.gif" height="400" width="400"/> |
|:---------------------------------------------------|:---------------------------------------------------|
| Рис. Табличний каркас | Рис. Блоковий каркас |
...
|<img src="img/05030.gif" width="400" height="400"/>|
|:---------------------------------------------------|
...
|![Рис. Прототип сторінки](img/05050.png)|
|:--------------------------------------|
...
|![Рис. Прототип сторінки](img/05060.png)|
|:--------------------------------------|
| Рис. Прототип сторінки |
