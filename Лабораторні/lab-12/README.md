...
13. Додати у файл контейнер `<script>`. 
14. Використовуючи метод console.log() вивести в консоль довільний текст
15. Створити дві числові змінні, внести в них значення. Використовуючи метод console.log() вивести в консоль сумму цілих чисел
16. Використовуючи консоль виконати попередні команди та порівняти результат
17. Створити файл з назвою script.js та помістити його поряд з файлом index.html
18. Видалити з файлу index.html секцію `<script>` та підключити файл script.js в секції `<head>`
19. У файл script.js помістити код, розроблений раніше та перевірити його роботу
20. У файл script.js помістити код, код, який виконує арифметичні операції над дробовими числами та перевірити його роботу. Пояснити результати таких операцій.
21. Виконати безпосередньо в консолі операції з попереднього пункту та порівняти результати з попереднім пунктом.
22. У файл script.js помістити код, який створює деякі змінні та присвоює їм певні значення. Отримати доступ до цих значень через інтерпритатор консолі.
23. У "підвал" сторінки та файл script.js помістити інформацію про виконавця роботи: група, ПІБ, дата виконання.
24. Для кожного етапу роботи зробити знімки екрану або скопіювати текст консолі, код JS та додати їх у звіт з описом кожного скіншота
